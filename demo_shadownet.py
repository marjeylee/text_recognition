...
if __name__ == '__main__':
    image_path = './data/test_images/1.jpg'
    weights_path = './model/shadownet/shadownet_2018-08-01-16-00-24.ckpt-6000'
    # recognize(image_path='./data/test_images/1.jpg', weights_path=weights_path)
    # recognize(image_path='./data/test_images/2.jpg', weights_path=weights_path)
    # recognize(image_path='./data/test_images/3.jpg', weights_path=weights_path)
    recognize(image_path='./data/test_images/5.jpg', weights_path=weights_path)
